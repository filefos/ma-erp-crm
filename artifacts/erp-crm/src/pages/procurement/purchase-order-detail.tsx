    ...
    <div className="max-w-4xl mx-auto space-y-4">
      <div className="no-print flex items-center gap-2 flex-wrap">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <ExportButtons docNumber={(po as any).poNumber ?? po.id?.toString() ?? "PO"} recipientPhone={(po as any).supplierPhone ?? undefined} recipientEmail={(supplier as any)?.email ?? (po as any).supplierEmail ?? undefined} companyId={(po as any).companyId ?? undefined} docTypeLabel="Purchase Order" />
        </div>
      </div>
