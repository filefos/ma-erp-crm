...
import { Building2, Pencil, Globe, Phone, Mail, Receipt } from "lucide-react";
...
export function CompaniesAdmin() {
  ...
  const [form, setForm] = useState<FormState>({
    ...
    email: "", phone: "", website: "", address: "", vatPercent: 5,
  });
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-muted-foreground text-sm">Manage Prime Max General Trading and Elite Prefab Industries.</p>
      </div>
              ...
              <CardHeader className="pb-3">
                <div className="flex items-start justify-between">
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-lg bg-[#0f2d5a] flex items-center justify-center">
      ...
      <Dialog open={editId !== null} onOpenChange={(o) => !o && setEditId(null)}>
        <DialogContent>
          ...
          <Button
            className="mt-4 bg-[#0f2d5a] hover:bg-[#1e6ab0] text-white"
