...
import { DealDetail } from "@/pages/crm/deal-detail";
...
import { CompanyDocuments } from "@/pages/admin/company-documents";
  ...
  return (
    <Switch>
      ...
      <Route path="/crm/pipeline">
        <ModuleGuard module="leads"><SalesPipeline /></ModuleGuard>
      </Route>
      ...
      <Route path="/crm/deals/:id">
        {(params) => (
          <ModuleGuard module="deals"><DealDetail id={params.id!} /></ModuleGuard>
        )}
      </Route>
      ...
      <Route path="/crm/activities">
        <ModuleGuard module="activities"><ActivitiesPage /></ModuleGuard>
      </Route>
      ...
      <Route path="/admin/activity-monitor">
        <AdminGuard><ActivityMonitor /></AdminGuard>
      </Route>
      <Route path="/admin/company-documents">
        <AdminGuard><CompanyDocuments /></AdminGuard>
      </Route>
