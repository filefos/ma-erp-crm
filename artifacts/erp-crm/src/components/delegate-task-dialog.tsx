...
import { useListUsers, useListCompanies } from "@workspace/api-client-react";
...
export function DelegateTaskDialog({ open, onClose, defaultLeadId, defaultLeadName, defaultUserId }: DelegateTaskDialogProps) {
  ...
  const otherUsers = users.filter((u: any) => u.id !== (user as any)?.id && u.isActive !== false);
        ...
        <div className="flex flex-col gap-4 py-2">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Select value={taskType} onValueChange={v => {
              ...
              setTaskLabel(defaultLeadName ? `Create ${typLabel} for ${defaultLeadName}` : `Create ${typLabel}`);
            }}>
